      ...
      <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.length > 0 ? (
          courses.map((course) => (
            <div
              key={course._id}
              className="shadow-lg hover:shadow-xl transition-shadow duration-300 snap-start border-y-2 rounded-2xl border-gray-100 backdrop-blur-xl text-gray-100 hero-card">
