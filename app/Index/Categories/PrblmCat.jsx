...
export default function PrblmCat() {
  return (
     <div className='container mx-auto mt-8 '>
            <div className="icon flex md:justify-center ">
              <div className="flex overflow-x-auto scroll-smooth snap-x gap-4 px-6 py-5 overflow-hidden scrollbar-star ">
                <button className="brutalist-button scroll-ms-6 snap-start algo flex-shrink-0 flex flex-col items-center p-4  h-28 w-28 md:h-32  md:w-32">
                ...
                <button className="brutalist-button flex-shrink-0 scroll-ms-6 snap-start maths flex flex-col items-center p-4  h-28 w-28 md:h-32  md:w-32">
                ...
                <button className="brutalist-button flex-shrink-0 scroll-ms-6 snap-start daily flex flex-col items-center p-4  h-28 w-28 md:h-32  md:w-32">
